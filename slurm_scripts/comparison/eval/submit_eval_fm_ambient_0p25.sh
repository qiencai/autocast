...
# 25%-progress checkpoint with explicit eval.mode=ambient.
#
# This charges the autoencoder decode->encode drift at every rollout step.
# Outputs are kept under eval_0p25_ambient/ so they do not overwrite the
# default auto->encode_once 25%-checkpoint evals.
#
